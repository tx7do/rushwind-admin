...
P
    ...
    <div class="flex gap-0.5 items-center">
      <button type="button" class="tb" :class="{ 'tb-active': isActive('bold') }" :title="$t('ui.editor.bold')" @click="actions.toggleBold">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('italic') }" :title="$t('ui.editor.italic')" @click="actions.toggleItalic">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('strike') }" :title="$t('ui.editor.strike')" @click="actions.toggleStrike">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('underline') }" :title="$t('ui.editor.underline')" @click="actions.toggleUnderline">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('code') }" :title="$t('ui.editor.code')" @click="actions.toggleCode">
    ...
    <div class="flex gap-0.5 items-center">
      <button type="button" class="tb" :title="$t('ui.editor.subscript')" @click="actions.toggleSubscript">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('superscript') }" :title="$t('ui.editor.superscript')" @click="actions.toggleSuperscript">
    ...
    <div class="flex gap-0.5 items-center">
      <button type="button" class="tb" :class="{ 'tb-active': isActive('bulletList') }" :title="$t('ui.editor.bulletList')" @click="actions.toggleBulletList">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('orderedList') }" :title="$t('ui.editor.orderedList')" @click="actions.toggleOrderedList">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('taskList') }" :title="$t('ui.editor.taskList')" @click="actions.toggleTaskList">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('blockquote') }" :title="$t('ui.editor.blockquote')" @click="actions.toggleBlockquote">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('codeBlock') }" :title="$t('ui.editor.insertCodeBlock')" @click="actions.insertCodeBlock">
      ...
      <button type="button" class="tb" :title="$t('ui.editor.insertTable')" @click="actions.insertTable">
      ...
      <button v-if="isActive('table')" type="button" class="tb text-red-500" :title="$t('ui.editor.deleteTable')" @click="actions.deleteTable">
      ...
      <button type="button" class="tb" :title="$t('ui.editor.insertHorizontalRule')" @click="actions.insertHorizontalRule">
    ...
    <div class="flex gap-0.5 items-center">
      <button type="button" class="tb" :class="{ 'tb-active': isActive('textAlign', { textAlign: 'left' }) }" :title="$t('ui.editor.left')" @click="actions.setAlign('left')">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('textAlign', { textAlign: 'center' }) }" :title="$t('ui.editor.center')" @click="actions.setAlign('center')">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('textAlign', { textAlign: 'right' }) }" :title="$t('ui.editor.right')" @click="actions.setAlign('right')">
      ...
      <button type="button" class="tb" :class="{ 'tb-active': isActive('textAlign', { textAlign: 'justify' }) }" :title="$t('ui.editor.justify')" @click="actions.setAlign('justify')">
    ...
    <div v-if="isActive('table')" class="flex gap-0.5 items-center">
      <button type="button" class="tb" :title="$t('ui.editor.addRowBefore')" @click="actions.addRowBefore">R+</button>
      <button type="button" class="tb" :title="$t('ui.editor.addRowAfter')" @click="actions.addRowAfter">+R</button>
      <button type="button" class="tb" :title="$t('ui.editor.deleteRow')" @click="actions.deleteRow">R-</button>
      <button type="button" class="tb" :title="$t('ui.editor.addColumnBefore')" @click="actions.addColumnBefore">C+</button>
      <button type="button" class="tb" :title="$t('ui.editor.addColumnAfter')" @click="actions.addColumnAfter">+C</button>
      <button type="button" class="tb" :title="$t('ui.editor.deleteColumn')" @click="actions.deleteColumn">C-</button>
      <button type="button" class="tb" :title="$t('ui.editor.mergeCells')" @click="actions.mergeCells">M</button>
      <button type="button" class="tb" :title="$t('ui.editor.splitCell')" @click="actions.splitCell">S</button>
      <button type="button" class="tb" :title="$t('ui.editor.toggleHeaderRow')" @click="actions.toggleHeaderRow">HR</button>
      <button type="button" class="tb" :title="$t('ui.editor.toggleHeaderColumn')" @click="actions.toggleHeaderColumn">HC</button>
      <button type="button" class="tb" :title="$t('ui.editor.toggleHeaderCell')" @click="actions.toggleHeaderCell">H</button>
    </div>

    <div v-if="isActive('table')" class="w-px h-4 mx-1.5 bg-[var(--tte-toolbar-border)]"></div>

    <div class="flex gap-0.5 items-center">
      <button type="button" class="tb" :disabled="!editor?.can().undo()" :title="$t('ui.editor.undo')" @click="actions.undo">
      ...
      <button type="button" class="tb" :disabled="!editor?.can().redo()" :title="$t('ui.editor.redo')" @click="actions.redo">
      ...
      <button type="button" class="tb" :title="$t('ui.editor.clearFormatting')" @click="actions.clearFormatting">
      ...
      <button type="button" class="tb text-red-500" :title="$t('ui.editor.clearContent')" @click="actions.clearContent">
        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
      </button>
    </div>
    ...
    <div class="flex gap-0.5 items-center">
      <button
        ...
        :title="isActive('link') ? $t('ui.editor.removeUrl') : $t('ui.editor.insertUrl')"
      ...
      <button type="button" class="tb" :title="$t('ui.editor.uploadImage')" @click="actions.uploadImage">
      ...
      <button type="button" class="tb" :title="$t('ui.editor.insertVideo')" @click="actions.insertVideo">
      ...
      <button type="button" class="tb" :title="$t('ui.editor.insertIframe')" @click="actions.insertIframe">
      ...
      <button type="button" class="tb" :title="$t('ui.editor.importMarkdown')" @click="actions.importMarkdown">MD</button>
